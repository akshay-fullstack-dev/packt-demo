<template>
    <div class="sticky top-0 z-50">
        <nav
            class="flex items-center relative justify-between flex-wrap bg-dark-grey py-4 lg:px-12 shadow border-solid border-t-2 border-blue-700">
            <div
                ...
                <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
                    <span class="font-semibold text-xl tracking-tight"><img
                            src="https://www.packtpub.com/images/logo-new.svg" alt="Logo" /></span>
                </div>
            </div>

            <div class="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
                <div class="text-md font-bold text-natural lg:flex-grow">
                ...
                <div class="flex ">
                    <template v-if="$page.props.auth.user">
                        <Link :href="route('dashboard')"
                            class="block text-md px-4 py-2 rounded text-natural ml-2 font-bold hover:text-white mt-4 hover:bg-grey-700 lg:mt-0">
                        Dashboard</Link>
                    </template>
                    <template v-else>
